...
import { LucideCalendarDays, LucideHeartHandshake, LucideSettings, LucideTicket, LucideUsersRound } from '@lucide/angular';

import { AuthService } from '../../core/auth/auth.service';

@Component({
  selector: 'dnms-admin-dashboard-page',
  imports: [RouterLink, LucideUsersRound, LucideTicket, LucideCalendarDays, LucideSettings, LucideHeartHandshake],
